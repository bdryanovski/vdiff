import { Block, Tree } from './structure/tree';
...
export class Context {
  ...
  // @TODO cover reporter with it's own type - not sure on the design at the moment
  ...
  // in this case youn could have more than one method, not sure even about the order of execution.
